  ...
  static prove(statement, witness) {
    ...
    const statementHash = utils.hash(
      ABICoder.encodeParameters(
        ['bytes32[2]', 'bytes32[2]', 'bytes32[2]', 'uint256', 'address'],
        [bn128.serialize(statement['Cn'].left()), bn128.serialize(statement['Cn'].right()), bn128.serialize(statement['y']), statement['epoch'], statement['sender']]
      )
    ...
    const y = utils.hash(ABICoder.encodeParameters(['bytes32', 'bytes32[2]', 'bytes32[2]'], [bn128.bytes(statementHash), bn128.serialize(result.BA.point()), bn128.serialize(result.BS.point())]));
    ...
    const x = utils.hash(ABICoder.encodeParameters(['bytes32', 'bytes32[2]', 'bytes32[2]'], [bn128.bytes(z), bn128.serialize(result.T_1.point()), bn128.serialize(result.T_2.point())]));
    ...
    result.c = utils.hash(
      ABICoder.encodeParameters(
        ...
        [bn128.bytes(x), bn128.serialize(A_y), bn128.serialize(A_b), bn128.serialize(A_t), bn128.serialize(A_u)]
      )
    );
    ...
    const o = utils.hash(ABICoder.encodeParameters(['bytes32'], [bn128.bytes(result.c)]));
